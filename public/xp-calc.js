/** Client-side XP formulas (keep in sync with src/xp/calculations.ts). */
(function (global) {
  ...
  function calculateBasicXp(stats) {
    ...
    const life = { value: lifeValue, spent: COST_LIFE * lifeValue, next: COST_LIFE };
    return {
